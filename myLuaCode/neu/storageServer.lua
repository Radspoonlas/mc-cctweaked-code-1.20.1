...
local handle={{name="",fun=sendCraftingJob},{name="getFuel",fun=getFuel},{name="getItem",fun=getItem},{"sortItem",fun=sortItem},{name="getCount",fun=sendCount},{name="itemList",fun=sendItemList}}
eventHandler:new()
